# Axlib Prometheus Exporter

## Introduction

[Prometheus](https://prometheus.io/) is one of the most widely used monitoring tools for managing highly available services supported by [Cloud Native Computing Foundation](https://www.cncf.io/). By providing Prometheus metrics in Axlib, node operators can easily adopt widely used display/alert tools such
...
1. From the root of the repository start Axlib `cargo run --release`.
